...
public class DateTime {
    ...
    public static final int YEAR_1970 = 1970;
    public static final long THOUSAND = 1000L;
    public static final int SIXTY = 60;
    public static final int TWENTYFOUR = 24;
    private static final long DAYS_TO_MILLISEC = TWENTYFOUR * SIXTY * SIXTY * THOUSAND;
    ...
    private static final long WEEKS_TO_MILLISEC = 7 * DAYS_TO_MILLISEC;
    public static final int DAYS_IN_MONTH = 30;
    private static final int[] TAGE_IM_MONAT
            = {0, 31, 28, 31, DAYS_IN_MONTH, 31, DAYS_IN_MONTH, 31, 31, DAYS_IN_MONTH, 31, DAYS_IN_MONTH, 31};
...
//        erzeugt ein Objekt, das den angebenen Zeitpunkt, repräsentiert.
        ...
        for (int i = 1; i < month; i++) {
            if (i == 1 || i == 3 || i == 5 || i == 7 || i == 8 || i == 10 || i == MONTHS_IN_YEAR) {
                dayCounter++;
...
//        }
        ...
        long yearToMillisec = DAYS_IN_YEAR * 24 * SIXTY * SIXTY * THOUSAND;
        long leapyearToMillisec = 366 * 24 * SIXTY * SIXTY * THOUSAND;
    ...
    public String getDate() {
        ...
        int jahrSchaetzung = tage / DAYS_IN_YEAR + YEAR_1970;
        int jahre = (tage - schaltJahreSeitBeginn(jahrSchaetzung))
                / DAYS_IN_YEAR;
        int jahreszahl = YEAR_1970 + jahre;
        int restTage = tage - jahre * DAYS_IN_YEAR
